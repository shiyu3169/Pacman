 ...
 */
public class MyPacManBFS extends PacmanController {
...
/*        while(!nodes.isEmpty()) {
            ...
            //check whether there is a pill
            if ((pillIndex == -1) || (game.isPillStillAvailable(pillIndex) ==null) || (!game.isPillStillAvailable(pillIndex))) {
